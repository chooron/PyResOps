    ...
    def summary(self) -> dict:
        ...
        return {
            ...
            "human_baseline": {
                ...
                "rule_compliance": self.human_baseline.rule_compliance_score if self.human_baseline else None,
            },
            "llm_no_mcp": {
                "success_rate": sum(r.success for r in self.llm_no_mcp_results) / max(len(self.llm_no_mcp_results), 1),
            ...
            "llm_with_mcp": {
                "success_rate": sum(r.success for r in self.llm_with_mcp_results) / max(len(self.llm_with_mcp_results), 1),
...
EXPERIMENT_SCENARIOS = [
    {
        ...
        "complexity": "low",
        "mcp_tools_required": ["get_reservoir_status", "calculate_flood_routing", "check_safety_constraints"],
    },
    {
        ...
        "complexity": "high",
        "mcp_tools_required": [
            "get_reservoir_status", "calculate_flood_routing",
            "check_safety_constraints", "get_downstream_impact", "query_historical_decisions",
        ],
    },
    {
        ...
        "complexity": "medium",
        "mcp_tools_required": [
            "get_reservoir_status", "calculate_power_generation",
    ...
    },
    {
        ...
        "mcp_tools_required": [
            "get_reservoir_status", "calculate_power_generation",
            "calculate_flood_routing", "check_safety_constraints", "optimize_multi_objective",
        ],
    },
    {
        ...
        "mcp_tools_required": [
            "get_reservoir_status", "calculate_flood_routing", "check_safety_constraints",
            "calculate_power_generation", "query_historical_decisions",
            "optimize_multi_objective", "get_downstream_impact",
        ],
    },
]
...
class MCPAgentExperiment:
    ...
    def _build_agent(self):
        ...
        from experiments.paper_experiment_runner import RESERVOIR_TOOLS, SYSTEM_PROMPT

        return Agent(
            model=Claude(id=self.model_id),
            tools=RESERVOIR_TOOLS,
    ...
    def run_scenario(self, scenario: dict) -> dict:
        ...
        try:
            ...
            final_text = str(run_response.content) if hasattr(run_response, "content") and run_response.content else ""
